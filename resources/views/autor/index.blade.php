    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="grid grid-cols-3">
            <div class="relative object-center content-center">
                <h1 class="text-xl">Administración de autores</h1>
            </div>
            ...
            <form action="{{ route('autor.buscar') }}" method="post">
                @csrf
                <flux:input type="text" label="Buscar autor" wire:model="autor" 
            ...
            <div class="fixed top-5 right-10">
                <flux:button href="{{ route('autor.create') }}" variant="primary" class="object-center inline-block">Agregar Autor</flux:button>
            </div>
        </div>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <flux:button href="/autor/{{ $autor->id }}/edit" variant="filled" class="object-center inline-block">Editar Autor</flux:button>
